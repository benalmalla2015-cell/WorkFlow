...
@section('title', 'الإعدادات | WorkFlow')

@section('content')
    <div class="mb-4">
        <h1 class="h3 mb-1">إعدادات النظام</h1>
        <div class="text-muted">ضبط هامش الربح الافتراضي وبيانات الشركة والبنك المستخدمة في الوثائق.</div>
    </div>
    ...
    <form method="POST" action="{{ route('admin.settings.update') }}" class="row g-4">
        ...
        <div class="col-12">
            <div class="card form-card">
                <div class="card-body p-4">
                    <h2 class="h5 section-title">هامش الربح</h2>
        ...
        <div class="col-lg-6">
            <div class="card form-card h-100">
                <div class="card-body p-4">
                    <h2 class="h5 section-title">بيانات الشركة</h2>
                    <div class="row g-3">
                        <div class="col-md-12">
        ...
        <div class="col-lg-6">
            <div class="card form-card h-100">
                <div class="card-body p-4">
                    <h2 class="h5 section-title">البيانات البنكية</h2>
                    <div class="row g-3">
                        <div class="col-md-12">
                        ...
                        <div class="col-12">
                            <label class="form-label">عنوان المستفيد</label>
                        ...
                        <div class="col-12">
                            <label class="form-label">عنوان البنك</label>
